//! A type used to reference a Node in the tree. It's just a wrapper for `[u8; 32]` with
//! some additional methods that makes it convenient to use, while not allowing unsafe things
//! like copy from a byte-array without checking length.
